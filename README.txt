  ...
  <main id="top">
    ...
    <section id="products">
      <div class="container">
        ...
        <div class="products">
          <article class="card"><div class="product-img"><img src="assets/home-safe-premium.png" alt="Home Safe Premium AS100"><span class="badge">UY UCHUN</span></div><div class="card-body"><h3>Home Safe Premium</h3><p>Model AS100 — uy uchun premium, zamonaviy va ishonchli seyf.</p><div class="specs"><span class="spec">Model: AS100</span><span class="spec">100 × 52 × 44 sm</span><span class="spec">Premium</span></div><div class="card-foot"><span class="price">19 300 000 so‘m</span><a class="btn" href="#contact">So‘rash</a></div></div></article>
